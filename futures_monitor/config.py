...
SYMBOL_CANDIDATE_DEFINITIONS = [
    ...
    {"value": "SHFE.ru", "code": "SHFE.ru", "name": "橡胶", "exchange": "SHFE"},
    {"value": "SHFE.sn", "code": "SHFE.sn", "name": "沪锡", "exchange": "SHFE"},
    {"value": "SHFE.bc", "code": "SHFE.bc", "name": "国际铜", "exchange": "SHFE"},
    {"value": "SHFE.br", "code": "SHFE.br", "name": "丁二烯橡胶", "exchange": "SHFE"},
    {"value": "SHFE.pb", "code": "SHFE.pb", "name": "沪铅", "exchange": "SHFE"},
    {"value": "SHFE.ni", "code": "SHFE.ni", "name": "沪镍", "exchange": "SHFE"},
    {"value": "SHFE.ad", "code": "SHFE.ad", "name": "铸造铝合金", "exchange": "SHFE"},
    {"value": "SHFE.ao", "code": "SHFE.ao", "name": "氧化铝", "exchange": "SHFE"},
    {"value": "SHFE.op", "code": "SHFE.op", "name": "胶版印刷纸", "exchange": "SHFE"},
    {"value": "SHFE.sp", "code": "SHFE.sp", "name": "纸浆", "exchange": "SHFE"},
    {"value": "SHFE.ss", "code": "SHFE.ss", "name": "不锈钢", "exchange": "SHFE"},
    ...
    {"value": "DCE.l", "code": "DCE.l", "name": "聚乙烯", "exchange": "DCE"},
    {"value": "DCE.p", "code": "DCE.p", "name": "棕榈油", "exchange": "DCE"},
    {"value": "DCE.jd", "code": "DCE.jd", "name": "鸡蛋", "exchange": "DCE"},
    {"value": "DCE.j", "code": "DCE.j", "name": "焦炭", "exchange": "DCE"},
    {"value": "DCE.jm", "code": "DCE.jm", "name": "焦煤", "exchange": "DCE"},
    ...
    {"value": "DCE.fb", "code": "DCE.fb", "name": "纤维板", "exchange": "DCE"},
    ...
    {"value": "CZCE.SP", "code": "CZCE.SP", "name": "纸浆", "exchange": "CZCE"},
    {"value": "CZCE.RI", "code": "CZCE.RI", "name": "早籼稻", "exchange": "CZCE"},
    {"value": "CZCE.PK", "code": "CZCE.PK", "name": "花生", "exchange": "CZCE"},
    {"value": "CZCE.AP", "code": "CZCE.AP", "name": "苹果", "exchange": "CZCE"},
    {"value": "CZCE.SF", "code": "CZCE.SF", "name": "硅铁", "exchange": "CZCE"},
    {"value": "CZCE.PM", "code": "CZCE.PM", "name": "普麦", "exchange": "CZCE"},
    {"value": "CZCE.PF", "code": "CZCE.PF", "name": "短纤", "exchange": "CZCE"},
    {"value": "CZCE.CJ", "code": "CZCE.CJ", "name": "红枣", "exchange": "CZCE"},
    {"value": "CZCE.LR", "code": "CZCE.LR", "name": "晚籼稻", "exchange": "CZCE"},
    {"value": "CZCE.SM", "code": "CZCE.SM", "name": "锰硅", "exchange": "CZCE"},
    {"value": "CZCE.JR", "code": "CZCE.JR", "name": "粳稻", "exchange": "CZCE"},
    {"value": "CZCE.RS", "code": "CZCE.RS", "name": "菜籽", "exchange": "CZCE"},
    {"value": "CZCE.PX", "code": "CZCE.PX", "name": "对二甲苯", "exchange": "CZCE"},
    {"value": "CZCE.OI", "code": "CZCE.OI", "name": "菜油", "exchange": "CZCE"},
    {"value": "CZCE.SH", "code": "CZCE.SH", "name": "烧碱", "exchange": "CZCE"},
    {"value": "CZCE.PR", "code": "CZCE.PR", "name": "瓶片", "exchange": "CZCE"},
    {"value": "CZCE.CY", "code": "CZCE.CY", "name": "棉纱", "exchange": "CZCE"},
    {"value": "CZCE.PL", "code": "CZCE.PL", "name": "丙烯", "exchange": "CZCE"},
    ...
    {"value": "CFFEX.TS", "code": "CFFEX.TS", "name": "2年期国债", "exchange": "CFFEX"},
    {"value": "CFFEX.TF", "code": "CFFEX.TF", "name": "5年期国债", "exchange": "CFFEX"},
    {"value": "CFFEX.TL", "code": "CFFEX.TL", "name": "30年期国债", "exchange": "CFFEX"},
    ...
    {"value": "INE.ec", "code": "INE.ec", "name": "集运指数（欧线）", "exchange": "INE"},
    {"value": "GFEX.si", "code": "GFEX.si", "name": "工业硅", "exchange": "GFEX"},
    {"value": "GFEX.lc", "code": "GFEX.lc", "name": "碳酸锂", "exchange": "GFEX"},
    {"value": "GFEX.pt", "code": "GFEX.pt", "name": "铂", "exchange": "GFEX"},
    {"value": "GFEX.ps", "code": "GFEX.ps", "name": "多晶硅", "exchange": "GFEX"},
    {"value": "GFEX.pd", "code": "GFEX.pd", "name": "钯", "exchange": "GFEX"},
]
